...
// 调用模块: 无
// 日　期:  2012年01月09日
// 备  注:  建议10ms调用一次,如需使用其它时间,L_KeyDeal_T,D_KeyDeal_T的定时计数初值注意修改
//-------------------------------------------------------------------------------------------------------
//=======================================================================================================
//u16 BitKeyValue;
...
void KeyInputScan(void)//开关量扫描输入
{
	...
	New_KeyValue.u32_Bit.Bit0  = Read_PROBE1_KEY;	//按键1
	New_KeyValue.u32_Bit.Bit1  = Read_PROBE2_KEY; //按键2
	New_KeyValue.u32_Bit.Bit2  = Read_PROBE3_KEY;  //按键3
